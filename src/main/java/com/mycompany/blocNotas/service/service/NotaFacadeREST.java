 ...
 */
package com.mycompany.blocNotas.service.service;
 ...
 */
@Stateless
@Path("com.mycompany.blocnotas.entities.nota")
public class NotaFacadeREST extends AbstractFacade<Nota> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Nota entity) {
        super.edit(entity);
    }
    ...
    public Nota find(@PathParam("id") Integer id) {
